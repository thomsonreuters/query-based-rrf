...
class ModernBertRegression(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, labels=None):
        ...
        # Safely extract the pooled output. ModernBERT, like many encoder models, 
        # utilizes the [CLS] token at index 0 for sequence-level representation.
...
def main(config_path, overrides=None):
    ...
    # Initialize tokenizer (AutoTokenizer automatically fetches the correct one for ModernBERT)
    ...
    # Initialize model using our custom class wrapping AutoModel
