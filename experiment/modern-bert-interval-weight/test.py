...
# Updated to import ModernBertRegression
...
def load_model(model_path, config):
    ...
    # Updated to use AutoTokenizer
    from transformers import AutoTokenizer
    tokenizer = AutoTokenizer.from_pretrained(model_path)
    
    # Updated to initialize ModernBertRegression
...
if __name__ == "__main__":
    ...
    model_path = f"{_base_experiment_dir}/modern-bert-interval-weight/experiments/{dataset}-{combo}_{timestamp}"
